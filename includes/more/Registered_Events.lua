...
function reg_event.incoming_chunk(id, data, modified, injected, blocked)
    ...
    elseif id == 0x00A then
        ...
        if packet['Player'] == player.id then
            ...
            Player['AGI'] = packet['AGI']
            Player['INT'] = packet['INT']
            Player['MND'] = packet['MND']
            Player['CHR'] = packet['CHR']
            Player['STR+'] = packet['STR Bonus']
            Player['DEX+'] = packet['DEX Bonus']
            Player['VIT+'] = packet['VIT Bonus']
            Player['AGI+'] = packet['AGI Bonus']
            Player['INT+'] = packet['INT Bonus']
            Player['MND+'] = packet['MND Bonus']
            Player['CHR+'] = packet['CHR Bonus']
        end
    --0x061--
    elseif id == 0x061 then
        local packet = packets.parse('incoming', data)
        Player['STR'] = packet['Base STR']
        Player['DEX'] = packet['Base DEX']
        Player['VIT'] = packet['Base VIT']
        Player['AGI'] = packet['Base AGI']
        Player['INT'] = packet['Base INT']
        Player['MND'] = packet['Base MND']
        Player['CHR'] = packet['Base CHR']
        Player['STR+'] = packet['Added STR']
        Player['DEX+'] = packet['Added DEX']
        Player['VIT+'] = packet['Added VIT']
        Player['AGI+'] = packet['Added AGI']
        Player['INT+'] = packet['Added INT']
        Player['MND+'] = packet['Added MND']
        Player['CHR+'] = packet['Added CHR']
