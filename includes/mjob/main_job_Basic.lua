...
function main_job_file_unload()
	---------------------------------------
	--put your file_unload rules here
	---------------------------------------
end
function main_job_status_change(new,old, status, set_gear)
	----------------------------------------
...
function main_job_pretarget(spell,status,set_gear)
	---------------------------------------
...
function main_job_buff_change(name,gain,status,set_gear)
	---------------------------------------
...
function main_job_midcast(spell,status,set_gear)
	---------------------------------------
...
function main_job_aftercast(spell,status,set_gear)
	---------------------------------------
...
function main_job_pet_change(pet,gain,status,set_gear)
	---------------------------------------
...
function main_job_pet_midcast(spell,status,set_gear)
	---------------------------------------
...
function main_job_pet_aftercast(spell,status,set_gear)
	---------------------------------------
...
function main_job_filtered_action(spell,status,set_gear)
	---------------------------------------
