...
Waltz = {
    debuff = S{'Max HP Down','Max MP Down','Magic Evasion Down','Max TP Down','Magic Atk. Down','Magic Acc. Down','Magic Def. Down','Defense Down','Evasion Down',
        'Attack Down','Accuracy Down','CHR Down','AGI Down','DEX Down','VIT Down','MND Down','INT Down','STR Down','bane','Bio','blindness','curse','Dia',
        'disease','Shock','Rasp','Choke','Frost','Burn','Drown','Flash','paralysis','plague','poison','silence','slow','weight'},
...
sets.obi = {Fire = {waist="Karin Obi"},Earth = {waist="Dorin Obi"},Water = {waist="Suirin Obi"},Wind = {waist="Furin Obi"},Ice = {waist="Hyorin Obi"},
...
Typ = {spells = S{'White Magic','Black Magic','Ninjutsu','Geomancy','Blue Magic','Bard Song'},abilitys = S{'/jobability','/pet','/weaponskill','/monsterskill'},}
...
jobs = {ammo = {"WAR","RDM","THF","PLD","DRK","BST","RNG","SAM","NIN","COR"},magic = {"WHM","BLM","RDM","BRD","SMN","SCH","GEO"},}
        --Weapon typs
weapon_types = {'Axe','Club','Dagger','Great_Axe','Great_Sword','Hand-to-Hand','Polearm','Scythe','Staff','Sword','Great_Katana','Katana'}
        --Range typs
range_type = {'Archery','Marksmanship','Throwing','Fishing','Soultrapper','Wind_Instruments','String_Instruments','Handbells','Other'}